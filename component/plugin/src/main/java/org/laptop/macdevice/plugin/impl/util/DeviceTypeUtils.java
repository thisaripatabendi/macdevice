...
package org.laptop.macdevice.plugin.impl.util;
...
/**
 * Contains utility methods used by macdevice plugin.
 */
public class DeviceTypeUtils {

    private static Log log = LogFactory.getLog(org.laptop.macdevice.plugin.impl.util.DeviceTypeUtils.class);
