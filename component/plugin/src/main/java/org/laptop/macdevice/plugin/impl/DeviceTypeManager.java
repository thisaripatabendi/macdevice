...
package org.laptop.macdevice.plugin.impl;
...
import org.laptop.macdevice.plugin.impl.feature.DeviceTypeFeatureManager;
...
/**
 * This represents the macdevice implementation of DeviceManagerService.
 */
public class DeviceTypeManager implements DeviceManager {
    ...
    public boolean enrollDevice(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Enrolling a new macdevice device : " + device.getDeviceIdentifier());
            }
            ...
            String msg = "Error while enrolling the macdevice device : " + device.getDeviceIdentifier();
            log.error(msg, e);
    ...
    public boolean modifyEnrollment(Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Modifying the macdevice device enrollment data");
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while updating the enrollment of the macdevice device : " +
    ...
    public boolean disenrollDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Dis-enrolling macdevice device : " + deviceId);
            }
            DeviceTypeDAO.beginTransaction();
            ...
            String msg = "Error while removing the macdevice device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public boolean isEnrolled(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Checking the enrollment of macdevice device : " + deviceId.getId());
            }
            Device iotDevice =
            ...
            String msg = "Error while checking the enrollment status of macdevice device : " +
                    deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
    ...
    public Device getDevice(DeviceIdentifier deviceId) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Getting the details of macdevice device : " + deviceId.getId());
            }
            device = deviceTypeDAO.getDeviceTypeDAO().getDevice(deviceId.getId());
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching the macdevice device : " + deviceId.getId();
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return device;
    ...
    public boolean updateDeviceInfo(DeviceIdentifier deviceIdentifier, Device device) throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("updating the details of macdevice device : " + deviceIdentifier);
            }
            DeviceTypeDAO.beginTransaction();
            status = deviceTypeDAO.getDeviceTypeDAO().updateDevice(device);
            DeviceTypeDAO.commitTransaction();
            ...
            String msg =
                    "Error while updating the macdevice device : " + deviceIdentifier;
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return status;
    ...
    public List<Device> getAllDevices() throws DeviceManagementException {
        ...
        try {
            if (log.isDebugEnabled()) {
                log.debug("Fetching the details of all macdevice devices");
            }
            devices = deviceTypeDAO.getDeviceTypeDAO().getAllDevices();
        } catch (DeviceMgtPluginException e) {
            String msg = "Error while fetching all macdevice devices.";
            log.error(msg, e);
            throw new DeviceManagementException(msg, e);
        }
        return devices;
