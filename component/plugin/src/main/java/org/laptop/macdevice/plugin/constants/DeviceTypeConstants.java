...
package org.laptop.macdevice.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "macdevice";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "macdevice_DEVICE_ID";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/macdevice/+/macdevicebatterylevel";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.macdevicebatterylevel";
