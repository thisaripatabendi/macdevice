...
package org.laptop.macdevice.api;

import org.laptop.macdevice.api.dto.DeviceJSON;
import org.laptop.macdevice.api.dto.SensorRecord;
import org.laptop.macdevice.api.util.APIUtil;
import org.laptop.macdevice.api.util.ZipUtil;
import org.laptop.macdevice.api.util.ZipArchive;
...
public class DeviceTypeServiceImpl implements DeviceTypeService {
    ...
    public Response changeStatus(@PathParam("deviceId") String deviceId,
        ...
        try {
            ...
            deviceIdentifiers.add(new DeviceIdentifier(deviceId, "macdevice"));
            APIUtil.getDeviceManagementService().addOperation("macdevice", commandOp,
                                                              deviceIdentifiers);
