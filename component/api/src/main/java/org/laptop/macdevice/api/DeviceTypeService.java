        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                @ExtensionProperty(name = "name", value = "macdevice"),
                                @ExtensionProperty(name = "context", value = "/macdevice"),
                        })
                }
        ),
        tags = {
                @Tag(name = "macdevice,device_management", description = "")
        }
)
@Scopes(
        scopes = {
                @Scope(
                        name = "Enroll device",
                        description = "",
                        key = "perm:macdevice:enroll",
                        permissions = {"/device-mgt/devices/enroll/macdevice"}
                )
        }
)
...
public interface DeviceTypeService {
    ...
    @ApiOperation(
            ...
            extensions = {
                    @Extension(properties = {
                            @ExtensionProperty(name = SCOPE, value = "perm:macdevice:enroll")
                    })
            }
    )
