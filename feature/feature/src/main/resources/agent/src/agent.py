    ...
    def run(self):
        ...
        while True:
            try:
                ...
                print ('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
                print ("LAPTOP STATUS : Exception in TempReaderThread: Could not successfully read Data")
                print ("LAPTOP_STATS: " + str(e))
                pass
...
def main():
    ...
    while True:
        try:
            ...
            print ("LAPTOP_STATS: Exception in RaspberryAgentThread (either KeyboardInterrupt or Other)")
            print ("LAPTOP_STATS: " + str(e))
            print ('~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~')
            pass
